...
// don't add using statement for Misakai.Bson.Serialization.Serializers to minimize dependencies on DefaultSerializer
using Misakai.Bson.IO;
using Misakai.Bson.Serialization.Attributes;
using Misakai.Bson.Serialization.Conventions;
using Misakai.Bson.Serialization.IdGenerators;
