        ...
        public void Parse(string url)
        {
            ...
            switch (connectionString.Connect)
            {
                case ClusterConnectionMode.Direct:
                    _connectionMode = Mongo.ConnectionMode.Direct;
                    break;
                case ClusterConnectionMode.ReplicaSet:
                    _connectionMode = Mongo.ConnectionMode.ReplicaSet;
                    break;
                case ClusterConnectionMode.Sharded:
                    _connectionMode = Mongo.ConnectionMode.ShardRouter;
                    break;
                case ClusterConnectionMode.Standalone:
                    _connectionMode = Mongo.ConnectionMode.Standalone;
                    break;
                default:
                    _connectionMode = Mongo.ConnectionMode.Automatic;
                    break;
            }
